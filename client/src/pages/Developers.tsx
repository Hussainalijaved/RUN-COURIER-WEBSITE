...
X-Api-Key: rc_live_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx`}
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-3">
                All endpoints return <code className="text-xs px-1.5 py-0.5 rounded bg-muted border font-mono">application/json</code>. All requests must use HTTPS.
              </p>
            </div>
  ...
  "message": "Too many requests. Limit is 60 per minute."
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-3">
                To prevent duplicate bookings, include an <code className="text-xs px-1.5 py-0.5 rounded bg-muted border font-mono">Idempotency-Key</code> header on{" "}
                <code className="text-xs px-1.5 py-0.5 rounded bg-muted border font-mono">POST /api/v1/book-job</code> requests. Repeat the same key within 30 seconds and you'll receive a 409 instead of a duplicate job.
              </p>
              <CodeBlock
                language="http"
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                ...
                <code className="text-xs px-1.5 py-0.5 rounded bg-muted border font-mono">error</code> code and a human-readable{" "}
                <code className="text-xs px-1.5 py-0.5 rounded bg-muted border font-mono">message</code>.
              </p>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <code key={s} className="text-xs px-2 py-1 rounded-md bg-muted border font-mono">
                    {s}
                  </code>
                ))}
              </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <p>
                    ...
                    <a href="mailto:sales@runcourier.co.uk" className="underline text-primary">
                      sales@runcourier.co.uk
                    </a>
                  </p>
                  <p>
                    <strong className="text-foreground">Website:</strong>{" "}
                    <a href="https://runcourier.co.uk/contact" className="underline text-primary">
                      runcourier.co.uk/contact
                    </a>
                  </p>
                  <p className="mt-4">
                    Don't have API access yet?{" "}
                    <Link href="/api-integration-request" className="underline text-primary">
                      Submit a request
                    </Link>{" "}
