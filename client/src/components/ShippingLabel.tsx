        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '5px', marginBottom: '2px', flexShrink: 0 }}>
            ...
            <div style={{ flex: 1, textAlign: 'center', overflow: 'hidden' }}>
              ...
              <div style={{ fontFamily: "'Courier New', monospace", fontSize: '9px', fontWeight: 'bold', letterSpacing: '2px', marginTop: '1px' }}>{job.trackingNumber}</div>
            </div>
          ...
          <div style={{
            ...
            {j.pickupBuildingName && (
              <div style={{ fontSize: '9px', fontWeight: 'bold', marginBottom: '1px' }}>{j.pickupBuildingName}</div>
            )}
            <div style={{ fontSize: '9px', lineHeight: 1.25 }}>{job.pickupAddress}</div>
            <div style={{ fontSize: '16px', fontWeight: 'bold', fontFamily: "'Courier New', monospace", marginTop: '2px', letterSpacing: '1.5px' }}>{job.pickupPostcode}</div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '10px', lineHeight: 1.25 }}>{job.deliveryAddress}</div>
            <div style={{ fontSize: '26px', fontWeight: 'bold', fontFamily: "'Courier New', monospace", marginTop: '3px', letterSpacing: '2px' }}>{job.deliveryPostcode}</div>
            {job.recipientName && (
